...
// PO has been implemented in V and this version
// Uses more fixed tree generation conditions
public class PlayerStrategyExpectimaxVII extends Player {
  ...
  public PlayerStrategyExpectimaxVII(int number) {

    super(number);
    super.name = "Expectimax VII";
  ...
  public PlayerStrategyExpectimaxVII(int number, int flag) {
  ...
  public void switchOutAsActionScores(GameState currentGS, ArrayList<Action> possibleActions, int printMode) {
    ...
    for (int i = 0; i < possibleActions.size(); i++) {
      ...
      finalScore = expectimax(root,false,MIN,MAX,2,false);
  ...
  public Action chooseAction(GameState currentGS, ArrayList<Action> possibleActions, int printMode) {
    ...
    this.switchOutAsActionScores(currentGSCopy, possibleActions, printMode);
