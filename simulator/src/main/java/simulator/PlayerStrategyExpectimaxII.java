...
public class PlayerStrategyExpectimaxII extends Player {
  ...
  public PlayerStrategyExpectimaxII(int number) {

    super(number);
    super.name = "Expectimax II";
  ...
  public PlayerStrategyExpectimaxII(int number, int flag) {
  ...
  public Action chooseAction(GameState currentGS, ArrayList<Action> possibleActions, int printMode) {
    ...
    if (highestScoringActions != null && highestScoringActions.size() != 0) {
  ...
  public static void buildExpectimaxChildren(TreeNode node, int printMode) {
