...
// Switches scores are altered to encourage more move use
// Uses TieBreaks to select its moves and when considering the move the opp
// would use.
public class PlayerStrategyExpectimaxX extends Player {
  ...
  public PlayerStrategyExpectimaxX(int number) {

    super(number);
    super.name = "Expectimax X";
  ...
  public PlayerStrategyExpectimaxX(int number, int flag) {
