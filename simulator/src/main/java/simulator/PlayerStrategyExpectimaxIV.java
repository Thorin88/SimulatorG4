...
public class PlayerStrategyExpectimaxIV extends Player {
  ...
  public PlayerStrategyExpectimaxIV(int number) {

    super(number);
    super.name = "Expectimax IV";
  ...
  public PlayerStrategyExpectimaxIV(int number, int flag) {
