...
// Uses dynamic turn ordering + can select from the switch scores
...
public class PlayerStrategyExpectimaxIX extends Player {
  ...
  public PlayerStrategyExpectimaxIX(int number) {

    super(number);
    super.name = "Expectimax IX";
  ...
  public PlayerStrategyExpectimaxIX(int number, int flag) {
