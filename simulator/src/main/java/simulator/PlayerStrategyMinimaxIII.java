...
public class PlayerStrategyMinimaxIII extends Player {
  ...
  public PlayerStrategyMinimaxIII(int number) {

    super(number);
    super.name = "Minimax - III";
  ...
  public PlayerStrategyMinimaxIII(int number, int flag) {
  ...
  public Action chooseAction(GameState currentGS, ArrayList<Action> possibleActions, int printMode) {
    ...
    if (speedResult == this.playerNumber) {
      ...
      for (int i = 0; i < numberOfChildren; i++) {
        ...
        // New stuff for UI
        possibleActions.get(i).agentScore = score;
