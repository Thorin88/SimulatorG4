...
public class PlayerStrategyExpectimaxVI extends Player {
  ...
  public PlayerStrategyExpectimaxVI(int number) {

    super(number);
    super.name = "Expectimax VI";
  ...
  public PlayerStrategyExpectimaxVI(int number, int flag) {
